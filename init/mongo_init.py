...
if __name__ == "__main__":
    ...
    # Delete everything in the collections if they exist and are non-empty
    ...
    def init_mongo():
        ...
        print(f"MongoDB succesfully initialized with data {list(deliveries_collection.find())} and {list(parcels_collection.find())}")
